    ...
    if (cellElement) {
      ...
      setTimeout(() => {
        if (popupRef.current) {
          ...
          // let topPosition = relativeTop + cellRect.height + 8 - 150;
      ...
      {popupDate && (
        ...
        >
          ...
          <div className="event-list flex flex-col-reverse">
            {events
              .filter((e) => e.date === popupDate)
              .map((event, idx) => (
                <div
                  key={idx}
                  className="event-item py-2 flex items-center border-b border-gray-100 last:border-0"
                >
                  <div className="w-2 h-2 bg-[#224674] rounded-full mr-3"></div>
                  <div className="flex-1">
                    <div className="font-medium text-[#224674] bg-[#C8E4FC] rounded-full px-2 py-1 w-fit">
                      {event.peptide?.name}
                    </div>
